...
import { Search, MapPin, Phone, ShieldCheck, Menu, X, ChevronDown, Home, Info, Layers, BookOpen, PhoneCall, ArrowRight, ShoppingCart, History } from 'lucide-react';
    ...
    <header className="sticky top-0 z-40 bg-white dark:bg-[#12121e] border-b border-[#171728]/10 dark:border-white/10 shadow-xs transition-colors duration-200">
      ...
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          {/* Separator between routes and account actions */}
          ...
          <button
            type="button"
            onClick={onOpenCart}
            className="relative flex items-center gap-1.5 bg-[#0E01B5] hover:bg-[#09007A] text-white px-2 sm:px-3 py-2 rounded-xl text-xs font-bold transition-colors cursor-pointer"
          >
          ...
          {authUser ? (
            <div className="relative">
              <button
                ...
                className="flex items-center gap-1.5 bg-[#0E01B5] hover:bg-[#09007A] text-white px-2 sm:px-3 py-2 rounded-xl text-xs font-bold transition-colors cursor-pointer"
                title="Your account"
              >
              ...
              {userMenuOpen && (
                <div className="absolute right-0 mt-2 w-60 bg-white dark:bg-[#1b1b2d] text-[#171728] dark:text-[#FAF9F6] rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 py-2 z-50 animate-in fade-in slide-in-from-top-1">
